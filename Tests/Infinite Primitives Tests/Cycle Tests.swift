...
@Suite("Infinite.Cycle - Observable")
struct CycleObservableTests {
    ...
    func headTailMatchesIteration() {
        ...
        // Since tail type changes after first access (becomes RotatedCollection),
...
@Suite("Infinite.Cycle - Equatable")
struct CycleEquatableTests {
